...
export const routes: Routes = [
  { path: 'dss/collections',  data: {crumb: 'dss.collections'}, children: [
      ...
      {path: ':id', data: {crumb: 'dss.collections.cCollection'}, children: [
          {path: '', component: DsFullView, data: {crumb: undefined}},
          {path: 'clusters/:clusterId/assets/:guid', component: AssetViewComponent, data: {crumb: 'dss.assets.cAsset'}},
